...
GOIDS = set([ # 86 items
    'GO:0006948', # BP      0 L07 D08 I     induction by virus of host cell-cell fusion(1 genes)
    ...
    'GO:0019048', # BP    173 L05 D06 I     modulation by virus of host morphology or physiology(4 genes)
    ...
    'GO:0019087', # BP      1 L06 D07 I     transformation of host cell by virus(4 genes)
    ...
    'GO:0039507', # BP     60 L07 D08 AI    suppression by virus of host molecular function(1 genes)
    'GO:0039520', # BP      0 L08 D09 AI    induction by virus of host autophagy(1 genes)
    'GO:0039521', # BP      0 L08 D09 AI    suppression by virus of host autophagy(1 genes)
    ...
    'GO:0042742', # BP      8 L04 D06 FI    defense response to bacterium(140 genes)
    ...
    'GO:0051838', # BP      0 L05 D08 BFIV  cytolysis by host of symbiont cells(1 genes)
    'GO:0051873', # BP      6 L04 D07 FIV   killing by host of symbiont cells(5 genes)
    'GO:0060139', # BP      2 L07 D12 AI    positive regulation of apoptotic process by virus(3 genes)
    'GO:0070945', # BP      0 L06 D10 FILV  neutrophil mediated killing of gram-negative bacterium(5 genes)
    'GO:0070946', # BP      0 L06 D10 FILV  neutrophil mediated killing of gram-positive bacterium(2 genes)
    'GO:0070947', # BP      0 L05 D09 FILV  neutrophil mediated killing of fungus(2 genes)
