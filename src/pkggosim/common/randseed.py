...
__copyright__ = "Copyright (C) 2015-2018, DV Klopfenstein, Haibao Tang. All rights reserved."
__author__ = "DV Klopfenstein"

import sys
import numpy as np

class RandomSeed32(object):
...
# Copyright (C) 2015-2018, DV Klopfenstein, Haibao Tang. All rights reserved."
